...
# The function gridWorld returns the transition function transitions and reward function M
def gridWorld(a, b):
    # Grid world layout:
    #
    #  ---------------------
    ...
    # Rewards are stored in a one dimensional array rewards[s]
    #
    ...
    # Transitions are stored in a 3 dimensional array transitions[s,s',a] such that
    # transitions[s,s',a] = Pr(s'|s,a)
